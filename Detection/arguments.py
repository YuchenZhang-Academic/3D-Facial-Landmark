...
class Args(object):
    ...
    def set_train_args(self):
        ...
        self.parser.add_argument("--dataset_dir", type=str, default=r"~/project/Face/Data/")
        ...
        self.parser.add_argument("--save_freq", type=int, default=10, help="save model frequency (per n epoch)")
    ...
    def set_test_args(self):
        ...
        self.parser.add_argument("--weight_path", type=str,
                            default=r"./checkpoints/epoch150.pkl",
